...
([Playground](https://go.dev/play/p/nAj2HeDF6J1))
...
func main() {
    ...
    c := jsqr.Get(j, `.tags.[ .name == "Drink" ].items.[0].name`)
...
([Playground](https://go.dev/play/p/1T4S7ShfVMr))
...
func main() {
    ...
    c := jsqr.GetStruct(s, `.Tags.[ .Name == "Drink" ].Items.[0].Name`)
